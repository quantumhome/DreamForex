...
{
    public partial class InvoiceSell_Pre : System.Web.UI.Page
    {
        ...
        protected void GridView2_SelectedIndexChanged(object sender, EventArgs e)
        {
                                        ...
                                        foreach(Control lblAmounts in td.Controls)
                                        {
                                            if (lblAmounts is Label)
                                            {
                                                if (lblAmounts.ID!= null &&  lblAmounts.ID.Contains("LblAmount"))
                                                {
                                                    ...
                                                    var amountValue = "0";
                                                    if (amount != null && !amount.Text.IsNullOrWhiteSpace())
                                                    {
                                                        amountValue= amount.Text;
                                                    }
                                                    wRs += Math.Round(Convert.ToDouble(amountValue));
                                                }
                                            }
            ...
            Response.Redirect("InvoiceSellDetails.aspx");
